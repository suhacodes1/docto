  ...
  return (
    <ServiceLandingLayout
      hero={{
        ...
        imageSrc: "/assets/img/who-we-work-with/13.webp",
      ...
      aboutBlock={{
        ...
        imageAlt: "Dermatology clinic about",
      }}
      featureBlock={{
      ...
      processBlock={{
        ...
        mainImageSrc: "/assets/img/who-we-work-with/15.webp",
      ...
      infoBlock={{
        ...
        centerImageSrc: '/assets/img/who-we-work-with/16.webp',
