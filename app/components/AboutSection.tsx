...
text-[clamp(60px,10vw,140px)] font-extrabold
...
"
            ...
            <div className="relative z-[2]">
              ...
              <div
                className="space-y-4 mb-8 text-base md:text-lg text-gray-700"
                data-aos="fade-up"
                data-aos-delay="400"
              >
                <p>
                  Digital Paradigm helps clinics, healthcare providers, and
                  medical startups build modern digital systems that support
                  their growth.
                </p>
