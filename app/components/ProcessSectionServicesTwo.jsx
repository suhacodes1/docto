...
const processSteps = [
  {
    ...
    description:
      "Understand clinic services, patient journey, and conversion goals.",
  },
  {
    number: "02",
    label: "STRUCTURE",
    ...
    description:
      "Design site architecture, patient flow, and booking funnel.",
  },
  {
    number: "03",
    label: "DESIGN",
    icon: Code,
    title: "Design & Interface Creation",
    description:
      "Create clean, high-converting layouts and UI.",
  },
  {
    number: "04",
    label: "DEVELOP",
    ...
    description:
      "Build the platform and integrate booking, forms, and analytics.",
  },
  {
    number: "05",
    label: "TEST",
    ...
    description:
      "Ensure performance, responsiveness, and usability.",
  },
  {
    number: "06",
    label: "LAUNCH",
    ...
    description:
      "Deploy the platform and monitor performance metrics.",
  },
];

export default function ProcessSectionServicesTwo() {
  ...
  return (
    <section style={{ background: "#f5f7fa", padding: "90px 0 0" }}>
      <div style={{ textAlign: "center", padding: "0 20px 56px" }}>
        ...
        >
          Digital Infrastructure <span style={{ color: "#ef2f6b" }}>Process</span>
        </h2>
        ...
        >
          We build high-converting digital platforms that attract patients and streamline bookings. From strategy to launch, we create websites and systems that drive real results.
        </p>
      </div>
