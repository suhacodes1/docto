...
const processSteps = [
  {
    ...
    description:
      "Evaluate existing reviews, testimonials, and online trust signals.",
  },
  {
    number: "02",
    label: "STRATEGY",
    ...
    description:
      "Plan review acquisition and credibility assets.",
  },
  {
    number: "03",
    label: "CREATION",
    icon: Code,
    title: "Content & Testimonial Creation",
    description:
      "Collect reviews, video testimonials, and proof.",
  },
  {
    number: "04",
    label: "DISTRIBUTION",
    ...
    description:
      "Publish across Google, website, and marketing assets.",
  },
  {
    number: "05",
    label: "MANAGEMENT",
    icon: Rocket,
    title: "Ongoing Reputation Management",
    description:
      "Monitor and maintain reputation across all channels.",
  },
];

export default function ProcessSectionServicesFive() {
  ...
  return (
    <section style={{ background: "#f5f7fa", padding: "90px 0 0" }}>
      <div style={{ textAlign: "center", padding: "0 20px 56px" }}>
        ...
        >
          Reputation & Authority <span style={{ color: "#ef2f6b" }}>Process</span>
        </h2>
        ...
        >
          We build trust and credibility that attracts premium patients. From reputation audits to ongoing management, we create authority that drives patient choice.
        </p>
      </div>
