...
const processSteps = [
  {
    ...
    label: "RESEARCH",
    icon: Lightbulb,
    title: "Market & Patient Research",
    description:
      "Identify patient demand and high-intent keywords.",
  },
  {
    number: "02",
    label: "STRATEGY",
    ...
    description:
      "Design patient acquisition campaigns.",
  },
  {
    number: "03",
    label: "CREATION",
    ...
    description:
      "Build ads, landing pages, and content assets.",
  },
  {
    number: "04",
    label: "LAUNCH",
    icon: SearchSlash,
    title: "Launch & Traffic Generation",
    description:
      "Deploy campaigns and start generating enquiries.",
  },
  {
    number: "05",
    label: "OPTIMISE",
    ...
    description:
      "Improve performance and scale winning channels.",
  },
];

export default function ProcessSectionServicesThree() {
  ...
  return (
    <section style={{ background: "#f5f7fa", padding: "90px 0 0" }}>
      <div style={{ textAlign: "center", padding: "0 20px 56px" }}>
        ...
        >
          Patient Acquisition <span style={{ color: "#ef2f6b" }}>Process</span>
        </h2>
        ...
        >
          We drive consistent patient growth through strategic marketing campaigns. From research to scaling, we build systems that attract the right patients at the right time.
        </p>
      </div>
