export default function Head() {
  return (
    <>
<title>About Us | Digital Paradigm - Healthcare Digital Experts</title>
        <meta name="description" content="Health - Digital Paradigm: Learn about our mission to help healthcare brands grow with clarity, trust, and strategic digital solutions. Meet our team and discover our approach." />
